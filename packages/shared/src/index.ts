...
export {
  ...
  isWardrobeModestyPreference,
  isWardrobeOutfitFormality,
  isWardrobeSetupProfile,
  isWardrobeSetupRelevance,
  isWardrobeSetupSource,
  isWardrobeSetupStatus,
  isWardrobeStyleBasics,
  isWardrobeTypicalDressCode,
